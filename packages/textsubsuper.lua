...
-- License: MIT
--
SILE.require("hacks/rules-strike-fill") -- HACKS
...
--  local kern = 0.5 * hbox.width * (1 - xRatio)

--  if (xRatio < 1) then SILE.call("kern", { width = kern }) end
...
These commands achieve their goal by trying the \doc:code{+sups} font feature for
superscripts, and the \doc:code{+subs} or \doc:code{+sinf} feature for subscripts.
...
with the \doc:code{libtexpdf} backend.}.
